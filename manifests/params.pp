...
#	$package_name_wget = [ 'chromium-gost-stable', 'myofficemail', 'myoffice', 'myoffice-presentation-editor-linux', 'sputnik-browser-stable', 'yandex-browser-beta' ]
	$package_ensure    = 'present'
        $ftp_server_name   = 'ftp://ftp.am.local/install'
...
case $::osfamily {
	...
	$package_name_local = [ 'chromium-gost-stable', 'myofficemail', 'myoffice', 'myoffice-presentation-editor-linux', 'sputnik-browser-stable', 'yandex-browser-beta' ]
	$downloads = [ '' ]
	$suffix = 'deb'
	...
	$downloads = [ 'MyOfficeMailSilent.sh' ]
	$package_name_local = [ 'MyOffice_Presentation_Editor_Linux.x86_64', 'myoffice.x86_64', 'yandex-browser-beta.x86_64' ]
	$suffix		   = 'rpm'
